...
% Note: cross-references can cause tagging issues, so they are disabled by default with
% the "draft" option. You can remove it if you would like to try to enable them.
\usepackage[hidelinks,pdfusetitle,draft]{hyperref}
\urlstyle{same}
