...
\documentclass[bibstyle=phys,ragged]{authesis}
...
% List of Abbreviations or Symbols (nomenclature), entered like a table.
% This environment accepts an optional argument that may be set to
% Abbreviations (default), Symbols, or Abbreviations and Symbols.
\begin{listofnomenclature}[Abbreviations]
AU & Auburn University \\
UA & University of Alabama
\end{listofnomenclature}
